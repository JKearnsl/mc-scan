...
pub fn button_primary(t: &Theme, status: button::Status) -> button::Style {
    ...
    match status {
        button::Status::Hovered => button::Style {
            background: Some(Background::Color(accent_hov)),
            ..base
        },
        button::Status::Pressed => button::Style {
            background: Some(Background::Color(accent_prs)),
            ..base
        },
        button::Status::Disabled => button::Style {
            background: Some(Background::Color(dis_bg)),
            text_color: dis_text,
            ..base
        },
        _ => base,
...
pub fn button_danger(t: &Theme, status: button::Status) -> button::Style {
    ...
    match status {
        button::Status::Hovered => button::Style {
            background: Some(Background::Color(bg_hov)),
            ..base
        },
        button::Status::Pressed => button::Style {
            background: Some(Background::Color(bg_prs)),
            ..base
        },
        _ => base,
    }
